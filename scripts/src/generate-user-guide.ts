...
function sectionHeading(text: string, level: 1 | 2 | 3 = 1): Paragraph {
  ...
  return new Paragraph({
    ...
    shading:
      level === 1 ? { type: ShadingType.SOLID, color: GREEN_LIGHT, fill: GREEN_LIGHT } : undefined,
    border:
      level === 1
        ? {
            bottom: {
...
export async function buildDocument(screenshots?: Map<string, Buffer>, captureOrder?: CaptureEntry[]): Promise<Buffer> {
  ...
  sections.push(
    ...
    noteBox(
      "لا يلزم تثبيت أي برنامج على الجهاز للنسخة الإلكترونية؛ يكفي فتح الرابط في المتصفح.",
      "tip",
    ),
    pageBreak(),
  );
  ...
  sections.push(
    ...
    noteBox(
      "بعد حفظ البيانات، تنتقل مباشرةً إلى ملف المريضة حيث يمكنك إضافة حالة حمل جديدة.",
      "tip",
    ),
    sectionHeading("4.4 عرض ملف المريضة وتعديله", 2),
    rtlPara("اضغط على اسم المريضة في القائمة للانتقال إلى ملفها الكامل. يعرض الملف:"),
    ...
    ...screenshotPlaceholder(
      "ملف المريضة – البيانات الشخصية وقائمة الحالات",
      screenshots?.get("ملف المريضة – البيانات الشخصية وقائمة الحالات"),
    ),
    pageBreak(),
  );
  ...
  sections.push(
    ...
    ...screenshotPlaceholder(
      "تفاصيل حالة الحمل – وضع العرض مع زر تصدير PDF",
      screenshots?.get("تفاصيل حالة الحمل – وضع العرض مع زر تصدير PDF"),
    ),
    pageBreak(),
  );
  ...
  sections.push(
    ...
    rtlPara("لتسجيل حضور مريضة أو غيابها، ابحث عنها في القائمة ثم:"),
    ...
    noteBox(
      "يُنصح بفتح ملف CSV في Excel باستخدام ترميز UTF-8 للحصول على النص العربي بشكل صحيح.",
      "tip",
    ),
  ...
  sections.push(
    ...
    noteBox(
      "إذا كانت صفحة التنبيهات فارغة، فهذا يعني أن كل الحالات مستوفية المتطلبات – وهو الهدف المثالي.",
      "tip",
    ),
    pageBreak(),
  );
  ...
  sections.push(
    ...
    rtlPara("اضغط «تنزيل» في بطاقة «حالات الحمل» للحصول على ملف CSV يحتوي على:"),
  ...
  sections.push(
    ...
    rtlPara("يمكن للمسؤول (Admin) الوصول إلى صفحة «إدارة المستخدمين» من الشريط الجانبي."),
    ...screenshotPlaceholder(
      "صفحة إدارة المستخدمين – قائمة الحسابات مع الأدوار",
      screenshots?.get("صفحة إدارة المستخدمين – قائمة الحسابات مع الأدوار"),
    ),
    ...
    noteBox(
      "لا يمكن حذف حساب نهائيًا من الواجهة – الإيقاف هو الخيار الأنسب للحسابات غير الفعّالة.",
      "warning",
    ),
    pageBreak(),
  );
  ...
  sections.push(
    ...
    infoTable([
      [
        "Android",
        "قم بتثبيت تطبيق Expo Go من متجر Google Play، ثم امسح رمز QR المُقدَّم من فريق الدعم",
      ],
  ...
  sections.push(
    ...
    new Table({
      ...
      rows: [
        ...
        ...[
          ...
          ([num, sector, hospital, count], i) =>
            new TableRow({
              children: [num, sector, hospital, count].map(
                (cell) =>
                  new TableCell({
                    shading:
                      i % 2 === 0
                    ...
                    children: [
                      new Paragraph({
                        ...
                        alignment: AlignmentType.RIGHT,
                        children: [
                          new TextRun({ text: cell, size: 20, color: GRAY_DARK, font: "Calibri" }),
                        ],
                      }),
                    ],
                  }),
    ...
    infoTable([
      ...
      [
        "6",
        "مستشفى الملك فهد المركزي (KFCH) – مستشفى تخصصي يستقبل تحويلات الحالات الحرجة من جميع القطاعات",
      ],
    ]),
    pageBreak(),
  );
  ...
  sections.push(
    ...
    infoTable(
      [
        [
          "منخفض (Low)",
          "لا توجد عوامل خطر أو عامل واحد طفيف – متابعة روتينية في المركز الصحي – اللون: أخضر",
        ],
        ["متوسط (Medium)", "عامل أو عاملان من المجموعة الأولى – متابعة مكثفة – اللون: أصفر"],
        [
          "عالٍ (High)",
          "عوامل خطر متعددة أو حالة مزمنة مُؤثِّرة – إحالة للمستشفى – اللون: برتقالي",
        ],
        [
          "حرج (Critical)",
          "حالة طارئة أو مضاعفة شديدة – إحالة فورية لـ KFCH أو أقرب مستشفى مجهَّز – اللون: أحمر غامق",
        ],
      ],
  ...
  sections.push(
    ...
    ...[
      ...
      rtlPara(`ج: ${a}`, {
        ...
        indent: { start: convertInchesToTwip(0.3) },
      }),
    ]),
  );
  ...
  const doc = new Document({
    ...
    description:
      "الدليل الشامل للمنظومة الإلكترونية لتتبع الحمل عالي الخطورة في تجمع جازان الصحي 2026",
    styles: {
      default: {
        document: {
          run: {
...
function buildHtml(): string {
  ...
  sections.push(
    htmlP(
      "هذا الدليل معدّ للمستخدمين المصرح لهم فقط ضمن منظومة تتبع الحمل عالي الخطورة التابعة لتجمع جازان الصحي. المعلومات الواردة فيه سرية ومخصصة للاستخدام الداخلي. يُحظر نشرها أو توزيعها خارج نطاق المنظومة.",
    ),
  );
  sections.push(
    htmlP(
  ...
  sections.push(
    htmlP(
      "منظومة تتبع الحمل عالي الخطورة هي نظام إلكتروني متكامل يهدف إلى استبدال نموذج العمل القائم على ملفات Excel والنماذج الورقية (Microsoft Forms) بمنصة رقمية مركزية لإدارة ومتابعة حالات الحمل عالي الخطورة في تجمع جازان الصحي.",
    ),
  );
  sections.push(htmlH2("1.2 الفوائد الرئيسية"));
  sections.push(
    htmlBullet("تتبع آني لحالات الحمل عالي الخطورة عبر جميع المراكز الصحية والمستشفيات في المنطقة"),
  );
  ...
  sections.push(
    htmlP(
      "عند فتح رابط المنظومة يظهر للمستخدم شاشة تسجيل الدخول الآمنة. تعرض الشاشة شعار تجمع جازان الصحي، واسم المنظومة، وحقلَي اسم المستخدم وكلمة المرور.",
    ),
  );
  ...
  sections.push(
    htmlNote("إذا نسيت كلمة المرور، تواصل مع مسؤول المنظومة (Admin) لإعادة تعيينها.", "warning"),
  );
  ...
  sections.push(
    htmlP(
      "يمكن التبديل بين العربية والإنجليزية من أيقونة اللغة الموجودة في أعلى الشريط الجانبي. تُحفَظ تفضيلات اللغة تلقائيًا في المتصفح.",
    ),
  );
  sections.push(`</div>`);
  sections.push(htmlPageBreak());
  ...
  sections.push(
    htmlP(
      "لوحة المعلومات هي الصفحة الرئيسية التي تعرض فور تسجيل الدخول. تُلخِّص الوضع الصحي الحالي لجميع حالات الحمل عالي الخطورة في المنطقة من خلال بطاقات إحصائية ومخططات بيانية.",
    ),
  );
  ...
  sections.push(
    htmlP(
      "مخطط دائري يوضح توزيع الحالات حسب مستوى الخطورة الأربعة: منخفض (أخضر)، متوسط (أصفر)، عالٍ (برتقالي)، حرج (أحمر).",
    ),
  );
  ...
  sections.push(
    htmlP(
      "يظهر شريط تنبيه برتقالي في أعلى الصفحة عندما يتجاوز عدد المواعيد المنقضية غير المُسجَّل حضورها حدَّ الإنذار (الافتراضي: 5 مواعيد). يمكن الضغط على «عرض المواعيد» للانتقال مباشرةً لقائمة الحالات التي تحتاج متابعة، أو الضغط على × لإغلاق الشريط مؤقتًا.",
    ),
  );
  sections.push(
    htmlNote("حدّ الإنذار قابل للتخصيص من صفحة الإعدادات من قِبَل المسؤول أو المنسق.", "info"),
  );
  sections.push(`</div>`);
  sections.push(htmlPageBreak());
  ...
  sections.push(
    htmlP(
      "تعرض صفحة «المرضى» قائمةً كاملةً بجميع الحوامل المُسجَّلات. تشمل كل بطاقة: الاسم، رقم الهوية الوطنية، رقم الجوال، المركز الصحي، والقطاع.",
    ),
  );
  ...
  sections.push(
    htmlP("اضغط زر «تسجيل مريضة جديدة» (الأخضر) في أعلى يمين الصفحة. ستنتقل إلى نموذج التسجيل."),
  );
  ...
  sections.push(
    htmlBullet("قائمة جميع حالات الحمل المُسجَّلة لها مع مستوى الخطورة وحالة الالتزام"),
  );
  ...
  sections.push(
    htmlP(
      "يمكن إضافة حالة حمل جديدة بطريقتين: من ملف المريضة مباشرةً بالضغط «إضافة حالة حمل»، أو من قائمة «الحالات» ثم «حالة جديدة».",
    ),
  );
  ...
  sections.push(
    htmlP(
      "صفحة المواعيد هي المحور الرئيسي لمتابعة حضور الحوامل في المستشفيات. تعرض جميع المواعيد المحجوزة مع إمكانية التصفية والبحث وتسجيل الحضور والتصدير.",
    ),
  );
  ...
  sections.push(
    htmlP("اضغط زر «تصدير CSV» لتنزيل المواعيد المعروضة. اضغط «طباعة» لفتح نافذة طباعة جاهزة."),
  );
  sections.push(
    htmlNote(
      "يُنصح بفتح ملف CSV في Excel باستخدام ترميز UTF-8 للحصول على النص العربي بشكل صحيح.",
  ...
  sections.push(
    htmlP(
      "صفحة التقارير توفر أدوات تصدير بيانات المنظومة بصيغة CSV وطباعة/حفظ كـ PDF، لاستخدامها في التحليل والتقارير الدورية.",
    ),
  );
  ...
  const faqs: [string, string][] = [
    ...
    [
      "كيف أُعدِّل بيانات حالة حمل بعد حفظها؟",
      "افتح تفاصيل الحالة، ثم اضغط «تعديل الحالة» لتفعيل وضع التعديل.",
    ],
    [
      "لماذا تظهر تنبيهات VTE على حالة بدون إنوكساباريين؟",
      "لأن الحالة مصنفة كـ VTE عالي الخطورة دون وصف الدواء المناسب.",
    ],
    [
      "هل تُحذَف التنبيهات تلقائيًا؟",
      "نعم، عند معالجة سبب التنبيه يختفي التنبيه عند تحديث الصفحة.",
    ],
    ["كيف أُغيِّر لغة الواجهة؟", "اضغط على أيقونة اللغة (عربي/English) في أعلى الشريط الجانبي."],
    [
      "ماذا أفعل إذا نسيت كلمة المرور؟",
      "تواصل مع مسؤول المنظومة (Admin) لإعادة تعيين كلمة المرور.",
    ],
    [
      "كيف أتواصل مع الدعم التقني؟",
      "عبر البريد الإلكتروني: his@jazan-health.gov.sa في ساعات الدوام (الأحد – الخميس).",
    ],
  ];
...
async function resolvePuppeteerExecutable(): Promise<string> {
  ...
  try {
    ...
    /* puppeteer didn't download a browser — continue */
  }
